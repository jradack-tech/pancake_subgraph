...
const DAI_WETH_PAIR = '0xc7c3ccce4fa25700fd5574da7e200ae28bbd36a3' // created block 10042267
...
export function getEthPriceInUSD(): BigDecimal {
  ...
  let busdPair = Pair.load(BUSD_WBNB_PAIR) // usdt is token1

  // all 3 have been created
  if (daiPair !== null && usdcPair !== null && usdtPair !== null && busdPair !== null) {
    let totalLiquidityETH = daiPair.reserve1.plus(usdcPair.reserve1).plus(usdtPair.reserve0).plus(busdPair.reserve0)
    ...
    return daiPair.token0Price
      ...
      .plus(busdPair.token1Price.times(usdtWeight))
